...
back = (252, 15, 190)#задаем цвет согласно цветовой схеме RGB
...
w1 = GameSprite('wall2.png',win_width / 2 - win_width / 3, win_height / 2, 300, 50)
w2 = GameSprite('walll.png', 370, 100, 50, 400)
...
#создаем спрайты
packman = Player('pacmanP.png', 5, win_height - 80, 80, 80, 0, 0)
final_sprite = GameSprite('pacn5.png', win_width - 85, win_height - 100, 80, 80)

monster1 = Enemy('pacman-red.png', win_width - 80, 150, 80, 80, 5)
monster2 = Enemy('Pacman.png', win_width - 80, 230, 80, 80, 5)
